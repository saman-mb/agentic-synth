...
> **v1/prototype** · Part of epic [#290](https://github.com/saman-mb/agentic-synth/issues/290) · Feeds [#297](https://github.com/saman-mb/agentic-synth/issues/297) / [#298](https://github.com/saman-mb/agentic-synth/issues/298) · Unblocks E5 [#294](https://github.com/saman-mb/agentic-synth/issues/294) · Macros: [#296](https://github.com/saman-mb/agentic-synth/issues/296) · IA closed via [#295](https://github.com/saman-mb/agentic-synth/issues/295).
...
| [#297](https://github.com/saman-mb/agentic-synth/issues/297) | [input.md](./input.md) | `say` / `error` input modes (stub until issue lands) |
