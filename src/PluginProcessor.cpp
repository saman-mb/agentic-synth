...
bool AgenticSynthAudioProcessor::hasEditor() const { return true; }

//==============================================================================
const juce::String AgenticSynthAudioProcessor::getName() const { return "Agentic Synth"; }
...
//==============================================================================
int AgenticSynthAudioProcessor::getNumPrograms() { return 1; }

int AgenticSynthAudioProcessor::getCurrentProgram() { return 0; }

void AgenticSynthAudioProcessor::setCurrentProgram(int index) { juce::ignoreUnused(index); }
...
//==============================================================================
void AgenticSynthAudioProcessor::getStateInformation(juce::MemoryBlock& destData) { juce::ignoreUnused(destData); }
...
//==============================================================================
juce::AudioProcessor* JUCE_CALLTYPE createPluginFilter() { return new AgenticSynthAudioProcessor(); }
