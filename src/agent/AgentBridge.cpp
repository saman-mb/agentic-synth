...
void AgentBridge::recordFeedback(FeedbackKind kind, const std::string& prompt,
...
std::string AgentBridge::buildSystemPrompt(const std::string& userPrompt) const {
    std::string base =
        "You are a synthesizer patch designer. Generate synth parameters as structured JSON.\n";
