...
double LFO::divisionBeatsPerCycle(LfoSyncDivision division) {
    switch (division) {
        case LfoSyncDivision::Whole:            return 4.0;
        case LfoSyncDivision::Half:             return 2.0;
        case LfoSyncDivision::Quarter:          return 1.0;
        case LfoSyncDivision::Eighth:           return 0.5;
        case LfoSyncDivision::Sixteenth:        return 0.25;
        case LfoSyncDivision::ThirtySecond:     return 0.125;
        case LfoSyncDivision::SixtyFourth:      return 0.0625;
        case LfoSyncDivision::WholeDotted:      return 6.0;
        case LfoSyncDivision::HalfDotted:       return 3.0;
        case LfoSyncDivision::QuarterDotted:    return 1.5;
        case LfoSyncDivision::EighthDotted:     return 0.75;
        case LfoSyncDivision::SixteenthDotted:  return 0.375;
        case LfoSyncDivision::HalfTriplet:      return 4.0 / 3.0;
        case LfoSyncDivision::QuarterTriplet:   return 2.0 / 3.0;
        case LfoSyncDivision::EighthTriplet:    return 1.0 / 3.0;
        case LfoSyncDivision::SixteenthTriplet: return 1.0 / 6.0;
    }
    return 1.0;
}
