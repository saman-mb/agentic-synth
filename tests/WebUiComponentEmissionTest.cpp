...
TEST_CASE("WebUiComponent registers all 11 AgentBridge subscribers on construction", "[WebUiComponent][Emission]") {
    GuiFixture fix;
    AgentBridge bridge;
    ...
    // 11 hookups: token, patch, done, error, rationale, suggest_variations,
